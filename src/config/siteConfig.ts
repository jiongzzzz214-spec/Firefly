...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		...
		// 360 = 洋红/玫粉（360 与 0 在 HSL 里等价，但控制面板滑块停在最右端）
		hue: 360,
		// 是否对访问者隐藏主题色选择器
		fixed: false,
	...
	// 站点开始日期，用于统计运行天数（页脚「运行时长」）
	// 与首篇文章《博客开张》(src/content/posts/hello/index.md, published: 2026-09-11) 保持一致
	siteStartDate: "2026-09-11",
