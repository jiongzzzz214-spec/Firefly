...
export const galleryConfig: GalleryConfig = {
	...
	albums: [
		...
		//
		// TODO: 原来模板作者的两个示例相册（可爱流萤 / 加密相册示例）已移除。
		//       把你自己拍的照片放进 public/gallery/相册id/ 目录，然后照下面格式加一条即可：
		//
		// {
		// 	id: "my-trip",                          // 对应 public/gallery/my-trip/ 目录
		// 	name: "我的相册",                        // 相册名称
		// 	description: "一句话描述",
		// 	location: "拍摄地点",
		// 	date: "2026-09-11",                     // 格式 YYYY-MM-DD
		// 	tags: ["标签1", "标签2"],
		// 	// password: "123456",                 // 需要密码才可查看时填写
		// 	// passwordHint: "提示文字",
		// },
	],
