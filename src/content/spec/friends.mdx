...
export const site = {
  name: "Jiongzzzz",
  desc: "Jiongzzzz的个人博客",
  url: "https://720620.xyz",
  // 本站头像（公网可直接访问的链接）
  avatar: "https://720620.xyz/assets/images/logo.png",
  email: "jiongzzzz214@gmail.com",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言/发送申请邮件至：<ObfuscatedEmail email={site.email} class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]" /></p>
